...
public class SyncCallLogsALL extends Service {
    private static final String TAG = SyncCallLogsALL.class.getName();
    Active active;
...
//      Cursor cursor = managedQuery(CallLog.Calls.CONTENT_URI, null, null, null, strOrder);
        ...
        Cursor cursor = getBaseContext().getContentResolver().query(CallLog.Calls.CONTENT_URI, null, null, null, strOrder);
